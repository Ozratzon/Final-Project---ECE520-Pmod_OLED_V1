...
HD_PWD='/home/ozratzon/test/test.runs/OLED_Design_PmodOLED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_Design_PmodOLED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_Design_PmodOLED_0_0.tcl
