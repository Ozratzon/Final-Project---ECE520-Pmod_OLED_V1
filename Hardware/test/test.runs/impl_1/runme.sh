...
HD_PWD='/home/ozratzon/test/test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OLED_Design_wrapper.tcl -notrace
