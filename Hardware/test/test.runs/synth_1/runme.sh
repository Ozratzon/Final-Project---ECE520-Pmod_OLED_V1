...
HD_PWD='/home/ozratzon/test/test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_Design_wrapper.tcl
