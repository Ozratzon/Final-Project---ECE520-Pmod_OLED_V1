...
HD_PWD='/home/ozratzon/test/test.runs/OLED_Design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_Design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_Design_rst_ps7_0_100M_0.tcl
